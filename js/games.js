// Generated by tools/games_gen.py; every move was validated with python-chess. / tools/games_gen.pyで自動生成し、python-chessで全手を検証済み。
// All annotations are original and do not reproduce other people's notes. / 解説はすべて独自に書き下ろし、他者の注釈を転載していない。
const FAMOUS_GAMES = [
 {
  "id": "opera",
  "title": "オペラ座の夜",
