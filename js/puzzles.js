// Generated by tools/verify_puzzles.py; every puzzle was validated with python-chess. / tools/verify_puzzles.pyで自動生成し、python-chessで全問検証済み。
// theme=learning topic; idea=original explanation of the tactic. / theme=まなぶの要素、idea=狙いの解説（すべて独自に記述）。
const PUZZLES = [
 {
  "title": "うらぐちからこんにちは",
  "theme": "backrank",
