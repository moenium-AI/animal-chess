...
const PUZZLES = [
 ...
 },
 {
  "title": "たまをちかづけて",
  "theme": "endgame",
  "idea": "ルックだけでは詰まない。まず自分の玉を近づけて逃げ道を消してから、ルックで最終列を封じる。",
 ...
 },
 {
  "title": "かいだんをつくる",
  "theme": "ladder",
  "idea": "二枚のルックの階段。まず一枚で段を封鎖し、もう一枚を最終列へ回す二手の型。",
 ...
 },
 {
  "title": "ルックでしとめる",
  "theme": "endgame",
  "idea": "玉とルックだけの寄せを三手で。自分の玉を一歩ずつ近づけ、相手の玉を端へ追い込んでから封じる。",
 ...
 },
 {
  "title": "とおいかいだん",
  "theme": "ladder",
  "idea": "離れた二枚のルックで階段を作る。まず段を封じ、交互に王手して三手で端まで押し込もう。",
